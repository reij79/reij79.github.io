(function () {
    ...
    myConnector.getData = function(table, doneCallback) {
        ...
        $.getJSON("http://localhost:8889/stat.data.abs.gov.au/sdmx-json/data/LABOUR_PRICE_INDEX/2.THRPEB.1+2+7.-.1.10+20+30.Q/all?detail=Full&dimensionAtObservation=AllDimensions", function(resp) {
